const timelineElements = [
  {
    ...
    location: "Remote",
    description: "Work with developing and maintaining software for the Cold Storage supply chain. This includes working with AWS services like: Lambda Functions, Cloud Formation, Api Gateway, Secrets Manager, DynamoDB, and RDS. Node.js, TypeORM, PostgreSQL, and Typescript is the back end. The front end is Angular.",
    buttonText: "N/A",
